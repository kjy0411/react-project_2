...
/*
    ...
    2. 변수
            ...
            return (
                ...
                =============
                 ...
                 => html
                    ...
                    2. 닫는태그는 반드시 닫는다
                       <input/><img/><br/><hr/>
                    3. <input type="text" style="width:100px"> => 오류
        ...
        state : 값을 유지하고 있는 상태
                ...
                => state변수는 설정 => setXxx를 이용한다
                setXxx() => 호출이 되면 리렌더링이 가능
                -------- 함수를 다시 호출
                -------- 브라우저의 화면이 갱신
        ** 1. 단점
                단방향 통신 => Redux (보완)
                문법이 어렵다 / 전체 구조가 복잡하다 => React-Query
